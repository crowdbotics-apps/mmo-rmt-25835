"""mmo_rmt_25835 URL Configuration
...
admin.site.site_header = "mmo-rmt"
admin.site.site_title = "mmo-rmt Admin Portal"
admin.site.index_title = "mmo-rmt Admin"

# swagger
api_info = openapi.Info(
    title="mmo-rmt API",
    default_version="v1",
    description="API documentation for mmo-rmt App",
)
